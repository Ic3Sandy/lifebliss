...
void main() {
  setUp(() {
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger.setMockMessageHandler(
      ...
      (ByteData? message) async {
        ...
        const String mockHtml = '<!DOCTYPE html><html><body><h1 id="app-title">Lifebliss</h1></body></html>';
  ...
  group('Full App Flow Integration Tests', () {
    testWidgets('App should start with loading screen and navigate to home page', (WidgetTester tester) async {
      // Build the main app
    ...
    testWidgets('Error handling - app should gracefully handle asset loading errors', (WidgetTester tester) async {
    ...
    testWidgets('Integration test with orientation changes', (WidgetTester tester) async {
      // Initialize app
      await tester.pumpWidget(const MyApp());
